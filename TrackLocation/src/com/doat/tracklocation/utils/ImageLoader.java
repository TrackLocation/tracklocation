...
import com.doat.tracklocation.BuildConfig;
...
public abstract class ImageLoader {
    ...
    private Boolean isRoundImages = false;

    protected ImageLoader(Context context, int imageSize, Boolean isRoundImages) {
        mResources = context.getResources();
        mImageSize = imageSize;
        mLoadingBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_person_black_24dp); ;
        this.isRoundImages = isRoundImages;
    }
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        if (bitmap != null) {
            ...
            imageView.setImageBitmap(this.isRoundImages ? Utils.getRoundedCornerImage(bitmap, false) : bitmap);
        } else if (cancelPotentialWork(data, imageView)) {
            final BitmapWorkerTask task = new BitmapWorkerTask(imageView);
            final AsyncDrawable asyncDrawable =
                    new AsyncDrawable(mResources, this.isRoundImages ? Utils.getRoundedCornerImage(mLoadingBitmap, true) : mLoadingBitmap, task);
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap != null && imageView != null) {                
                setImageBitmap(imageView, isRoundImages ? Utils.getRoundedCornerImage(bitmap, false) : bitmap);
            }
        }
